...
example_dict = {
  "Team": ['Arizona Cardinals', 'Atlanta Falcons', 'Baltimore Ravens', 'Buffalo Bills', 
           ...
           'San Diego Chargers', 'Los Angeles Rams', 'St. Louis Rams',
  ...
  "City_Abbrev": ['ARI', 'ATL', 'BAL', 'BUF', 'CAR', 'CHI', 'CIN', 'CLE', 'DAL', 'DEN', 'DET', 
                  'GNB', 'HOU', 'IND', 'JAX', 'KAN', 'LVR', 'OAK', 'LAC', 'SD', 'LAR', 'STL', 'MIA', 
...
def schedule_scraper(year):
    ...
    for i in headers:
        ...
        elif i == 'Pts' and pts_ind == 0:
            new_headers.append('PtsW')
            pts_ind += 1
        elif i == 'Pts' and pts_ind > 0:
            new_headers.append('PtsL')
    print(new_headers)
    ...
    df_sched = pd.DataFrame(player_stats, columns = new_headers)
    day = []
    month = []
    year = []
...
df_all_season_final = full_season_pull('2009')
...
years_pull = ['2010','2011','2012','2013','2014','2015','2016','2017','2018','2019',
              '2020','2021']
for i in years_pull:
